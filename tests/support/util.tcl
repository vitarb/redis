...
proc generate_fuzzy_traffic_on_key {key duration} {
    ...
    # TODO (value-embedding): enable append and incr operation
    ...
    set string_commands {BITCOUNT BITFIELD BITOP BITPOS DECR DECRBY GET GETBIT GETRANGE GETSET MGET MSET MSETNX PSETEX SET SETBIT SETEX SETNX SETRANGE LCS STRLEN}
